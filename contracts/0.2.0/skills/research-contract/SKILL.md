...
Compose the Idea Definition, selected Product Profile, and host limits into the project-specific v0.2 Research Contract.
...
The contract is schema-valid, references exactly one v0.2 Profile, stays within host limits, and makes all branch and visualization requirements explicit.
