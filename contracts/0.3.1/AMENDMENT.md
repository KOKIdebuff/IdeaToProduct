# Contract Amendment 0.3.1 — Report and Chart Artifact Architecture

## Status

Approved Contract Amendment. This document changes only the report and chart
artifact architecture for Contract Bundle `0.3.1`. All behavior not explicitly
...
For Bundle `0.3.1` only, this amendment supersedes the report/chart format
