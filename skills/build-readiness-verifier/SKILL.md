...
Compute the sole authoritative v0.1 Build Readiness result from all effective required checks and accepted-risk decisions.
...
Exactly one schema-valid readiness result exists for the evaluated state and its status follows all v0.1 critical and waiver rules.
